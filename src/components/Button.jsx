    ...
    <div className='flex flex-row justify-between items-center space-x-4'>
      ...
      >
        <a href="https://people-utility-token.gitbook.io/peoples-utility-token/" target="_blank" rel="noopener noreferrer">
          ...
          Whitepaper
        </a><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h13M12 5l7 7-7 7" /></svg>
      </button>
    </div>
  );
};
