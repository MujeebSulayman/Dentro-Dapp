...
const Button = ({ styles }) => {
  return (
    <div className='flex flex-row justify-between items-center space-x-4'>
      ...
      <button
        type='button'
        className={`py-4 px-6 flex-1 justify-between items-center bg-white font-poppins font-normal text-[18px] text-white outline-none ${styles} rounded-[5px] mb-[50px] circle-btn`}
      >
