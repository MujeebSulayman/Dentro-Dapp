const FeedbackCard = ({ content, title }) => (
  <div>
    <div className='flex justify-between flex-col px-10 py-12 rounded-[20px] bg-white/10 max-w-[370px] md:mr-10 sm:mr-5 mr-0 my-5 backdrop-blur-sm	 backdrop-brightness-150 md:backdrop-filter-none'>
