  ...
  return (
    <section className={layout.section}>
      <div className={layout.sectionInfo}>
        ...
        <p
          className={`${styles.paragraph2} w-full className='flex justity-center items-center ml-7 max-w-[470px] py-[10px] px-[13px] bg-discount-gradient rounded-[10px] mt-9 text-start`}
        >
