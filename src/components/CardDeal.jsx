  ...
  return (
    <section className={layout.section}>
      <div className={layout.sectionInfo}>
        ...
        <p
          className={`${styles.paragraph2} w-full className='flex justity-center items-center py-[10px] px-[7px] bg-discount-gradient rounded-[10px] max-content-[470px] mt-9 text-start`}
        >
