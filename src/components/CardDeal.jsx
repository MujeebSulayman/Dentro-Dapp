  ...
  return (
    <section className={layout.section}>
      <div className={layout.sectionInfo}>
        ...
        <p
          className={`${styles.paragraph2} w-full className='justity-center items-center mr-7 max-content-[470px] max-w-[470px] py-[10px] px-[13px] bg-discount-gradient rounded-[10px] mt-7`}
        >
